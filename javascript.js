let arr = [
  ...
  function PrintDeveloper() {
    //Write your code here , just console.log
        arr.forEach((highSalary)=>{
            if(highSalary.salary > 1000){
                console.log(highSalary.name);
            }
        })
  }
  ...
  function recursiveAddData() {
    //Write your code here, just console.log
    arr.forEach((removeData)=>{
        if(removeData.age === 18 && removeData.age === 20)
            {
  ...
  function concatenateArray() {
    //Write your code here, just console.log
    let arr1 = [
        { id: 4, name: 'john Cena', age: 28, profession: 'Java developer', salary: 1E8 },
        { id: 5, name: 'jack Ma', age: 30, profession: '.Net developer', salary: 1E9 },
        { id: 6, name: 'karen Arjun', age: 29, profession: 'Linex admin', salary: 1E9 },
      ];
